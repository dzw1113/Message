...
import com.icip.framework.wx.MPSDK4J;
import com.icip.framework.wx.commons.WxEventType;
import com.icip.framework.wx.commons.WxMsgType;
import com.icip.framework.wx.map.AesException;
import com.icip.framework.wx.map.WXBizMsgCrypt;
import com.icip.framework.wx.util.StreamTool;
import com.icip.framework.wx.util.XMLHandler;
...
import com.icip.framework.wx.vo.ReceiveMsg;
...
public class WxBase {
    ...
    public String handlerPush() throws Exception {
        ...
        if("component_verify_ticket".equals(info_type)) {
        	wxHandler.eComponentVerifyTicket(this.rm);
        } else if("unauthorized".equals(info_type)) {
