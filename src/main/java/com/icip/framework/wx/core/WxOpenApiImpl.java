...
import com.icip.framework.wx.vo.AuthInfo;
...
public class WxOpenApiImpl implements WxOpenApi {
    ...
    public String getAuthorizerOption(String authAppId, String optionName) throws WxRespException {
        ...
        if (log.isInfoEnabled()) {
            String info = packLogMessage("获取授权公众号["+authAppId+"]", option_value, optionName);
            log.info("{}",info);
        }
    ...
    public void setAuthorizerOption(String authAppId, String optionName, String optionValue) throws WxRespException {
        ...
        if (log.isInfoEnabled()) {
            String info = packLogMessage("设置授权公众号["+authAppId+"]", optionValue, optionName);
            log.info("{}",info);
        }
    }
    
    private String packLogMessage(String info, String optionValue, String optionName) {
    	if("location_report".equals(optionName)) {
      ...
      } else if("voice_recognize".equals(optionName)) {
      	info += "语音识别选项成功,当前状态为: ";
        info += (optionValue.equals("0")?"关闭":"开启");
      } else if("customer_service".equals(optionName)) {
      	info += "多客服选项成功,当前状态为: ";
        info += (optionValue.equals("0")?"关闭":"开启");
      }
