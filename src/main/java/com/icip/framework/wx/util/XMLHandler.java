...
import com.icip.framework.wx.vo.PicInfo;
import com.icip.framework.wx.vo.ReceiveMsg;
import com.icip.utils.bean.BeanUtils;
...
public class XMLHandler extends DefaultHandler2 {
    ...
    public void endElement(String uri,
        ...
        if("MsgID".equals(qName)) 
        	qName = "Longitude";
        else if("Location_X".equals(qName) || "Location_Y".equals(qName)) 
        	qName = "Longitude";
        else if("ComponentVerifyTicket".equals(qName))
        	qName = "Ticket";
        
        BeanUtils.setProperty(msg, qName, attrVal);
